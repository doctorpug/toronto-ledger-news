...
const Header = () => {
  ...
  return (
    <header className="news-header sticky top-0 z-50 bg-white border-b-4 border-primary">
      {/* Recent News Banner */}
      <div className="bg-red-600 text-white text-center py-2 px-4 text-sm font-bold uppercase tracking-wider">
        <span className="inline-flex items-center px-2 py-1 bg-red-600 text-white text-xs font-bold uppercase rounded-sm mr-2">
          ●&nbsp;RECENT
        </span>
